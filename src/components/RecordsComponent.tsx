...
const RecordsComponent = () => {
    ...
    const [products, setProducts] = useState<product[]>([]); // Initialize an empty array of the correct type
    ...
    useEffect(() => {
      ...
      async function fetchData() { 
        ...
        const response = await axios.get<product[]>('http://localhost:8082/group-graph/converter/productOffers');
